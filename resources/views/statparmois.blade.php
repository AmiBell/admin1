...
$query = "SELECT dateRes, count(id_reservation) FROM  reservations where dateRes between 2018/04/01 and 2018/04/31 group by dateRes";
...
<body>
  <div id="content">
    ...
    <h1>Reservations Effectuées par jour</h1>
  </div>
